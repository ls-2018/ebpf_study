...
type sysProgramSpecs struct {
	HandleSw          *ebpf.ProgramSpec `ebpf:"handle_sw"`
	HandleTp          *ebpf.ProgramSpec `ebpf:"handle_tp"`
	UretprobeReadline *ebpf.ProgramSpec `ebpf:"uretprobe_readline"`
}
...
type sysPrograms struct {
	HandleSw          *ebpf.Program `ebpf:"handle_sw"`
	HandleTp          *ebpf.Program `ebpf:"handle_tp"`
	UretprobeReadline *ebpf.Program `ebpf:"uretprobe_readline"`
}
